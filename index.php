...
<body>
			...
			<div class="navbar-nav">
				...
				<div class="navbar-item dropdown">
					...
					<div class="dropdown-menu media-list dropdown-menu-end">
						...
						<a href="javascript:;" class="dropdown-item media">
							<div class="media-left">
								<img src="assets/img/user/barcelona.png" class="media-object" alt="" />
								<i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
							</div>
							<div class="media-body">
								<h6 class="media-heading">Fc barcelone</h6>
								<p>wanna sign a contract?</p>
				...
				<div class="navbar-item navbar-user dropdown">
					<a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
						<img src="assets/img/user/chkir.jpg" alt="" /> 
						<span>
							<span class="d-none d-md-inline">Faissal aoukacha</span>
							<b class="caret"></b>
						</span>
					</a>
	...
	function editdTask(id){
			...
			if(document.getElementById(id).getAttribute('data-type') == "1"){
				document.getElementById("tasktypefeature").checked=true;
			}else{
				document.getElementById("tasktypebug").checked=true;
